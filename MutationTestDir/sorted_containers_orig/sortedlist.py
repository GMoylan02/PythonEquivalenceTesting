...
def _make_cmp(seq_op, symbol, doc):  # pragma: no mutate
...
class SortedList(MutableSequence):
    ...
    * :func:`SortedList._reset`
    ...
    __lt__ = _make_cmp(lt, '<', 'less than')  # pragma: no mutate
    __gt__ = _make_cmp(gt, '>', 'greater than')  # pragma: no mutate
    __le__ = _make_cmp(le, '<=', 'less than or equal to')  # pragma: no mutate
    __ge__ = _make_cmp(ge, '>=', 'greater than or equal to')  # pragma: no mutate
